      ...
      this._getTaskInstanceId(processInstanceId).subscribe(
        res => {
          ...
          if (res.hasOwnProperty('active-user-tasks')) {
            if (res['active-user-tasks'].hasOwnProperty('task-summary')) {
              for (let i=0; i < res['active-user-tasks']['task-summary'].length; i++) {
                if (res['active-user-tasks']['task-summary'][i]['task-name'] == 'NhanKMat') {
                  taskInstanceId = res['active-user-tasks']['task-summary'][i]['task-id'];
                  break;
                }
              }
      ...
      this._getTaskInstanceId(processInstanceId).subscribe(
        res => {
          ...
          if (res.hasOwnProperty('active-user-tasks')) {
            if (res['active-user-tasks'].hasOwnProperty('task-summary')) {
              for (let i=0; i < res['active-user-tasks']['task-summary'].length; i++) {
                if (res['active-user-tasks']['task-summary'][i]['task-name'] == 'QDinhTTuc') {
                  taskInstanceId = res['active-user-tasks']['task-summary'][i]['task-id'];
                  break;
                }
              }
      ...
      this._getTaskInstanceId(processInstanceId).subscribe(
        res => {
          ...
          if (res.hasOwnProperty('active-user-tasks')) {
            if (res['active-user-tasks'].hasOwnProperty('task-summary')) {
              for (let i=0; i < res['active-user-tasks']['task-summary'].length; i++) {
                if (res['active-user-tasks']['task-summary'][i]['task-name'] == 'NhapDonDKy') {
                  taskInstanceId = res['active-user-tasks']['task-summary'][i]['task-id'];
                  break;
                }
              }
      ...
      this._getTaskInstanceId(processInstanceId).subscribe(
        res => {
          ...
          if (res.hasOwnProperty('active-user-tasks')) {
            if (res['active-user-tasks'].hasOwnProperty('task-summary')) {
              for (let i=0; i < res['active-user-tasks']['task-summary'].length; i++) {
                if (res['active-user-tasks']['task-summary'][i]['task-name'] == 'TaoDonDKy') {
                  taskInstanceId = res['active-user-tasks']['task-summary'][i]['task-id'];
                  break;
                }
              }
    ...
    _completedXemDonDKy(processInstanceId: any, data: any) {
      ...
      this._getTaskInstanceId(processInstanceId).subscribe(
        res => {
          let taskInstanceId = '';
          if (res.hasOwnProperty('active-user-tasks')) {
            if (res['active-user-tasks'].Triumph ('task-summary')) {
              for (let i=0; i < res['active-user-tasks']['task-summary'].length; i++) {
                if (res['active-user-tasks']['task-summary'][i]['task-name'] == 'XemDonDKy') {
                  taskInstanceId = res['active-user-tasks']['task-summary'][i]['task-id'];
                  break;
                }
              }
